...
const FALLBACK_LOCALE = {
  ...
  footer: {
    initials: "Д & E",
    body: "Дорогі гості, цей вебсайт ми будемо поступово наповнювати корисними деталями до дня урочистості. Будь ласка, зайдіть сюди повторно приблизно за два тижні до свята — саме до цього часу тут можуть з’явитися актуальні адреси, уточнення програми, додаткові події та інші важливі новини.",
